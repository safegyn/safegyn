...
public abstract class AbstractDao<T> {
    ...
    public Pageable getPageAble(Short pageSize) {
        if (pageSize == null)
            return new PageRequest(ZERO_INT, PAGE_DEFAULT_SIZE);
        return new PageRequest(ZERO_INT, pageSize);
    }
    ...
    public Pageable getPageAble(Short pageSize, Integer pageNo, Sort.Direction sortDirection, String sortProperties) {
        ...
        if (pageSize != null && pageSize > 0)
            return new PageRequest(index, pageSize, getSortDirection(sortDirection), sortProperties);
        return new PageRequest(index, PAGE_DEFAULT_SIZE, getSortDirection(sortDirection), sortProperties);
    }
